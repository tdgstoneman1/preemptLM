...
| ------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| `preempt/core/`                 | Shared vocabulary:`enums.py` (`ParquetCompressionCodecs`), `encoding.py` (`PayloadEncoding` + `parse_payload_encoding_tag`), `protocols.py` (`IExpertCache` / `IExpertLoader` / `ITokenizer` / `IModelRunner` capability protocols).                              | MLX, PyTorch, backends, model adapters, training libs |
