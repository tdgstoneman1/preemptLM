...
def _make_corrupting_decoder(
    ...
    """Wrap `decode_serialized_expert` to corrupt an expert's *reinstall*.
...
async def _main(args: argparse.Namespace) -> None:
    ...
    original_decode = residency_module.decode_serialized_expert
    corrupt_decode, _, fires = _make_corrupting_decoder(original_decode)
    residency_module.decode_serialized_expert = corrupt_decode  # type: ignore[assignment]
    try:
        ...
        residency_module.decode_serialized_expert = original_decode  # type: ignore[assignment]
